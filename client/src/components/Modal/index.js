...
const Modal = props => (
    <div className='transition ease-in-out container modal shadow w-2/5 min-h-36 bg-white fixed top-32 inset-x-1/3 rounded z-20 p-5 overscroll-y-auto w-full max-h-full overflow-x-hidden justify-center'>
